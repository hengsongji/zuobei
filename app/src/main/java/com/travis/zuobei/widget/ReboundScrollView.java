package com.travis.zuobei.widget;
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                ValueAnimator animator = ValueAnimator.ofInt(contentView.getTop()-originalRect.top, 0);
                animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    @Override
                    public void onAnimationUpdate(ValueAnimator animation) {
                        int value = (int) animation.getAnimatedValue();
                        if (mBounceListener != null) {
                            mBounceListener.onOffsetChanged(value);
                        }
                    }
                });
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (shouldMove) {
                    ...
                    if (mBounceListener != null) {
                        mBounceListener.onOffsetChanged(offset);
                    }
